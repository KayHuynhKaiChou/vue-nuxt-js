<template>
    <div v-if="product" style="width: 1380px" class="mx-auto px-4 sm:px-6 lg:px-0">
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 mx-auto max-md:px-2 ">
        <div class="img">
          <div class="img-box h-full max-lg:mx-auto ">
            <img :src="product.image" class="max-lg:mx-auto lg:ml-auto h-full object-cover" alt="product.id"/>
          </div>
        </div>
        <div
            class="data w-full lg:pr-8 pr-0 xl:justify-start justify-center flex items-center max-lg:pb-10 xl:my-2 lg:my-5 my-0">
          <div class="data w-full max-w-xl">
            <p class="text-lg font-medium leading-8 text-indigo-600 mb-4">Product detail&nbsp; /&nbsp; {{ product.type }}
            </p>
            ...
            <div class="text-gray-500 text-base font-normal mb-5">
...
const { data: product, status } = await useAsyncData(
    "list-product",
    () => handleGetProductById(route.params.id as string),
)
</script>
